...
import { modelChanged, rerender, onModelChange, onRender, findings, setFindings, onApplied } from "./core/bus.js";
...
import { REACH, reaching, paintTargetChip, showRootHelp } from "./ui/host.js";
...
let FIND, CODE_VARIANT, BASELINE, DW_TAB, VFILTER, ctxEl, DRAG, IMPORTED, TOPO_MODE, PAL, PALI, TOURI;
...
setNavigator(go);
/* What other screens ask this one to do. Wrapped rather than passed straight:
   `killCtx` is a const declared a thousand lines further down, and naming it
   here would be a read from its dead zone. These resolve when they are called,
