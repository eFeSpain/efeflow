...
import { $, $$, esc, el, cssEsc, toast, setNavigator } from "./ui/shell.js";
...
let FIND, CUR, PENDING, POS, LANES, zoom, SEL, timers, CODE_VARIANT, BASELINE, DW_TAB, TOOL, VFILTER, ctxEl, DRAG, IMPORTED, SETSEL, TOPO_MODE, PAL, PALI, TOURI;
